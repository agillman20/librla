...
- [ORTH_SKETCH_FUTURE.md](ORTH_SKETCH_FUTURE.md) — Prioritized future improvements for `orth_sketch` (revive `feat/certify` error certificates, guard tightening, fast→lstsq auto-fallback) and rejected options with rationale (early-exit pivoted QR, full Gu–Eisenstat strong-RRQR, incremental growth).
