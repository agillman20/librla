%==========================================================================
% test6_kahan.m - Test with Kahan matrix (384x384, theta=0.8)
%
%   Tests basic ID algorithms (id_sketch, id_rrqr) on a Kahan matrix.
%==========================================================================

function test6_kahan()
    fprintf('======================================================================\n');
    fprintf('TEST 6: Kahan Matrix\n');
    fprintf('======================================================================\n');
    ...
    % -------------------------------------------------------------------------
    fprintf('\n2. libid_rrqr.id_rrqr (deterministic RRQR via LAPACK)\n');
    fprintf('----------------------------------------------------------------------\n');

    tic;
    [k2, piv2, T2] = libid_rrqr.id_rrqr(A, k_target);
    t2 = toc;
