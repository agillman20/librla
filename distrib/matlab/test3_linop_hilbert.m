%==========================================================================
% test3_linop_hilbert.m - Simple test with LinearOperators
%
%   Tests libid.id_sketch with LinearOperators on a medium-size Hilbert matrix:
...
function test3_linop_hilbert()
    fprintf('======================================================================\n');
    fprintf('TEST 3: LinearOperators - Hilbert Matrix\n');
    fprintf('======================================================================\n');
    ...
    tic;
    [k1, piv1, T1] = libid.id_sketch(A, k_target);
    t1 = toc;
    ...
    tic;
    [k2, piv2, T2] = libid.id_sketch(A_linop_explicit, k_target);
    t2 = toc;
    ...
    tic;
    [k3, piv3, T3] = libid.id_sketch(A_linop_mf, k_target);
    t3 = toc;
