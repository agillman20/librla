...
that provides the user the option of three different factorizations: QR,
SVD and interpolatory decomposition.
...
librla. The examples involve fixed rank or tolerance
approximations.}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Problem
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
